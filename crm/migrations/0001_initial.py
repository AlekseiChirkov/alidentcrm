# Generated by Django 3.0 on 2020-03-31 07:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Активен', 'Активен'), ('Завершен', 'Завершен'), ('Приостановлен', 'Приостановлен')], max_length=64, verbose_name='Статус')),
            ],
            options={
                'verbose_name': 'Запись',
