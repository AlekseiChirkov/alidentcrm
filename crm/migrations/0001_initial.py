    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cheque', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='crm.Appointment')),
            ],
            options={
                'verbose_name': 'Доход',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='crm.Income'),
        ),
        migrations.AddField(
            model_name='appointment',
            name='status',
