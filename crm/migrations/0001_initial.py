...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('finished', models.IntegerField(null=True, verbose_name='Завершенных записей')),
                ('canceled', models.IntegerField(null=True, verbose_name='Отмененных записей')),
                ('amount', models.DecimalField(decimal_places=2, max_digits=10, null=True, verbose_name='Общий доход')),
                ('expense', models.DecimalField(decimal_places=2, max_digits=10, null=True, verbose_name='Общий расход')),
                ('ratio', models.DecimalField(decimal_places=2, max_digits=10, null=True, verbose_name='Соотношение')),
            ],
            options={
                'verbose_name': 'Доход',
