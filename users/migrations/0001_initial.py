    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(blank=True, choices=[('Владелец', 'Владелец'), ('Персонал', 'Персонал'), ('Клиент', 'Клиент')], max_length=64, null=True, verbose_name='Категория пользователя')),
